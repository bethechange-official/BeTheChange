...
export default function EditProduct() {
  ...
  useEffect(() => {
    Promise.all([adminCategoryService.getAll(), adminCollectionService.getAll(), adminProductService.getById(id)])
  ...
  if (!formData) return <AdminLayout title="Edit Product"><div className="p-6 text-sm text-rose-700">{error || 'Loading product…'}</div></AdminLayout>;
